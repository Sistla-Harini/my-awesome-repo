...
public class OneWeb1
{
	public static void main(String[] args)
	{
       ...
       WebElement Obj5 = ObjDriver.findElement(By.xpath("//*[@id=\"content\"]/div/div[2]/div/form/div[2]/a"));
       Obj5.click();
       WebElement Obj6 = ObjDriver.findElement(By.xpath("//*[@id=\"content\"]/form/div/"
       		+ "div[2]/input"));
       Obj6.click();
       WebElement Obj7 = ObjDriver.findElement(By.xpath("//*[@id=\"account-forgotten\"]/div[1]"));
       if(Obj7.isDisplayed());
       {
